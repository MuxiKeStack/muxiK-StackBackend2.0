...
func collectCurriculumHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CollectCurriculumRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCollectCurriculumLogic(r.Context(), svcCtx)
		resp, err := l.CollectCurriculum(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
