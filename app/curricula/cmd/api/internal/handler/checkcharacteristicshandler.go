...
func checkCharacteristicsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.CheckCharacteristicsRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewCheckCharacteristicsLogic(r.Context(), svcCtx)
		resp, err := l.CheckCharacteristics(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
