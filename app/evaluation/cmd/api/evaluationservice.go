...
import (
	...
	"github.com/MuxiKeStack/muxiK-StackBackend2.0/app/evaluation/cmd/api/internal/handler"
...
var configFile = flag.String("f", "etc/evaluationservice.yaml", "the config file")
