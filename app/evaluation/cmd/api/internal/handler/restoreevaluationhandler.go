...
func RestoreEvaluationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.RestoreEvaluationRequest
		if err := httpx.Parse(r, &req); err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
			return
		}

		l := logic.NewRestoreEvaluationLogic(r.Context(), svcCtx)
		resp, err := l.RestoreEvaluation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
